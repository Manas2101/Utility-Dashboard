class ReleaseManager {
        ...
        try {
            ...
            if (this.releases.length === 1) {
                ...
                setTimeout(() => {
                    ...
                    alert('📁 FALLBACK MODE: Server not available\n\n' +

                          '1. A JSON file was downloaded to your Downloads folder\n' +

                          '2. Replace the releases.json file in the portal folder\n' +

                          '3. This ensures team members see the data\n\n' +

                          'Consider starting the Python server for automatic sync!');
    ...
    downloadReleasesFile() {
        ...
        // Store the download link for manual use
